...
const Cryptos = () => {
  return (
    <div>
      {/* Banner Section */}
      <section className="bg-[url('/images/pages/trading-and-tools/market/CryptoTradingBanner.png')] bg-cover bg-center section">
      ...
      <div className="section container flex justify-center">
        <Image className="md:w-full hidden md:block  " src="/images/pages/trading-and-tools/market/crypto-table.png" alt="Forex Graph" width={1000} height={1000} />
      </div>
      ...
      <div className="section container">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-start min-[1390px]:justify-between gap-10 pt-[90px]">
          <div className="w-full hidden min-[1390px]:flex">
            <Image
              src="/images/pages/trading-and-tools/market/crypto-carousel.png"
