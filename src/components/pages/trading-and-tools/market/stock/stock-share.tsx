...
const StockShare = () => {
    return (
        <div>
            {/* Banner Section */}
            <section className="bg-[url('/images/pages/trading-and-tools/market/ShareStockBanner.png')] bg-cover bg-center section">
            ...
            {/* Most Popular Card 1 */}
            <MostPopularCard
                image="/images/pages/trading-and-tools/market/crypto-currency.png"
                heading={
                    <>
            ...
            {/* Most Popular Card 2 */}
            <MostPopularCard
                image="/images/pages/trading-and-tools/market/crypto-with-doyos.png"
                heading={
                    <>
                        Why trade&nbsp;
            ...
            <div className="section container flex justify-center">
                <Image className="md:w-full hidden md:block  " src="/images/pages/trading-and-tools/market/share-stock-graph.png" alt="Forex Graph" width={1000} height={1000} />
            </div>
            ...
            <div className="section container">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-start min-[1390px]:justify-between gap-10 pt-[90px]">
                    <div className="w-full hidden min-[1390px]:flex">
                        <Image
                            src="/images/pages/trading-and-tools/market/stock-carousel.png"
