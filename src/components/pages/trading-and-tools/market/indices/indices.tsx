  ...
  return (
    <div>
      ...
      <div className="section container flex justify-center">
        <Image className="w-full " src="/images/pages/trading-and-tools/market/indices-table.png" alt="indices table" width={1000} height={1000} />
      </div>
      ...
      <div className="section container">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-start min-[1390px]:justify-between gap-10 pt-[90px]">
          <div className="w-full hidden min-[1390px]:flex">
            <Image
              src="/images/pages/trading-and-tools/market/indices-carousel.png "
