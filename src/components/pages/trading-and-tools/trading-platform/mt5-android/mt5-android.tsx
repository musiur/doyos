...
const Mt5Android = () => {
    return (
        ...
        <div>
            <HeroSection
                backgroundUrl="/images/pages/trading-and-tools/market/Mt5-Android-Banner.png"
                heading={<>MT5 Android</>}
            />

            <MostPopularCard
                image="/images/pages/trading-and-tools/market/download-mt5-android.png"
                imageLeft={false}
                heading={
                    <>
            ...
            <div className="section container">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-start min-[1390px]:justify-between gap-10 pt-[90px]">
                    <div className="w-full hidden min-[1390px]:flex">
                        <Image
                            src="/images/pages/trading-and-tools/market/why-trade-forex.png "
